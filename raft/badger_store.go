...
type Options struct {
	...
	// BadgerOptions contains any specific Badger options you mightb
	// want to specify.
...
// runVlogGC manages the garbage collection of the value log in the Badger database based on thresholds and timers.
// It runs conditionally when the vlog size exceeds a certain threshold and at specific intervals.
